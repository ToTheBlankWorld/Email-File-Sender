                    ...
                    <div className="relative mx-auto mt-10 w-full max-w-xl">
                        {files.length > 0 &&
                            files.map((file, idx) => (
                                <motion.div
                                    ...
                                    className={cn(
                                        "relative z-40 mx-auto mt-4 flex w-full flex-col items-start justify-start overflow-hidden rounded-md bg-neutral-950 p-4 md:h-24",
                        ...
                        {!files.length && (
                            <motion.div
                                ...
                                className={cn(
                                    "relative z-40 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md bg-neutral-950 group-hover/file:shadow-2xl",
                                    "shadow-[0px_10px_50px_rgba(0,0,0,0.3)] border border-white/5",
                                )}
                            >
                                {isDragActive ? (
                                    <motion.p
